            ...
            function loadDatatable() {
                if (!$.fn.dataTable.isDataTable('#tabel-loglogin')) {
                    var TableData = $('#tabel-loglogin').DataTable({
                        ...
                        processing: true,
                        serverSide: true,
                        ajax: "<?php echo e(ci_route('info_sistem.datatables')); ?>",
                        columns: [{
                                data: 'DT_RowIndex',
                                class: 'padat',
                                searchable: false,
    ...
    <?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\SI_Desa_Jangkang\resources\views/admin/setting/info_sistem/log_login.blade.php ENDPATH**/ ?>